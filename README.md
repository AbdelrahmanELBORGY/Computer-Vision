...
# Projects Overview
1. Image Mosaicing & Stitching
Implementation of automated image stitching to create seamless panoramas.
...
2. Augmented Reality (AR) Fundamentals
Exploration of camera calibration and 3D-to-2D projections to overlay virtual objects onto real-world scenes.

Key Features: Estimating camera intrinsics/extrinsics and rendering 3D wireframes over detected markers.

Files: AR.ipynb.

3. Food Product Analysis & OCR
Integration of computer vision into functional software for health tracking.
